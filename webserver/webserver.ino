...
const char* ssid     = "HITRON-F5A0";
const char* password = "tigo13101976";
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("th { padding: 12px; background-color: #0043af; color: black; }");
            ...
            client.println(bme.pressure / 100.0F);
            ...
            client.println(" Kohms</span></td></tr>"); 
